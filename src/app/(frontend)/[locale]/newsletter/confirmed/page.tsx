...
export default async function ConfirmedPage({
  ...
  const L = isFR
    ? {
        ...
        title: 'Vous êtes désormais inscrit·e.',
        body: 'Bienvenue dans la newsletter du CAD. Vous recevrez une fois par mois nos actualités, événements et appels à candidature.',
        cta1: { label: 'Retour à la home', href: `/${locale}` },
        cta2: { label: 'Voir les événements', href: `/${locale}/events` },
      }
    : {
        eyebrow: 'Subscription confirmed',
        title: 'You are now subscribed.',
        body: 'Welcome to the CAD newsletter. You will receive our news, events and admission calls once a month.',
        cta1: { label: 'Back to home', href: `/${locale}` },
        cta2: { label: 'See events', href: `/${locale}/events` },
      }
